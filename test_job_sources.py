...
class SourceTests(unittest.TestCase):
    ...
    def test_salary_requires_explicit_currency_period_and_basis(self):
        ...
        tiered = salary_fields('The base pay for this position is:\n$114,000—$142,500 CAD\n$142,000—$177,500 CAD\n$176,000—$220,000 CAD')
        self.assertEqual(tiered['salary_extraction_confidence'], 'tiered')
        self.assertEqual(tiered['salary_min'], 114000)
        self.assertEqual(tiered['salary_max'], 220000)
        self.assertEqual(tiered['salary_basis'], 'base')
        stripe = salary_fields('The annual salary range for this role in the primary location is CA$121,100 - CA$181,700. For sales roles, the range provided is their OTE range.', 'Toronto')
        self.assertEqual(stripe['salary_min'], 121100)
        self.assertEqual(stripe['salary_max'], 181700)
        self.assertEqual(stripe['salary_basis'], 'base')
